        ...
        >
            <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <CardContent sx={{ p: 0, '&:last-child': { pb: 0 }, paddingLeft: '10px' }}>
                    ...
                    >
                        <Typography color={theme.custom.misc.shadow} variant='titleSmalltextMedium'>{campaign.title}</Typography>
                        <Typography color={theme.custom.surface.onColorVariant} variant='bodySmall'>{campaign.description}</Typography>
                    </Box>
                </CardContent>
            </Box>
